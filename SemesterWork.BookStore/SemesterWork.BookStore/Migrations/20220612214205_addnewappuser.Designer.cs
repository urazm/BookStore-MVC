...
namespace SemesterWork.BookStore.Migrations
{
    ...
    [Migration("20220612214205_addnewappuser")]
    partial class addnewappuser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SemesterWork.BookStore.Data.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SemesterWork.BookStore.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SemesterWork.BookStore.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SemesterWork.BookStore.Data.Books", b =>
                {
                    b.HasOne("SemesterWork.BookStore.Data.Language", "Language")
                        .WithMany("Books")
